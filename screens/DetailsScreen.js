...
const DetailsScreen = ({ route }) => {
  ...
  const fetchProductDetails = async () => {
   try {
    ...
    const response = await fetch(
     `${API_BASE_URL}/getProductDetails.php?product_id=${productId}` // Using API_BASE_URL here
    );
 ...
 const toggleFavorite = async () => {
  try {
   ...
   const response = await fetch(`${API_BASE_URL}/updateFavorite.php`, { // Using API_BASE_URL here
    method: 'POST',
